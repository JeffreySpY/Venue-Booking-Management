...
<body <?php body_class(); ?>>
	...
	<div class="wrapper"> 
		...
		<section class="header-section" role="header">
			<nav class="navbar navbar-default" style = "background-color:#e7ad44">
				<div class="container">
					<div class="row">
						<!-- Brand and toggle get grouped for better mobile display -->
						<div class="col-sm-3 navbar-header">
							<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" style=" z-index: 999999;color:white">
							
								<span class="sr-only"><?php echo "hii";_e('Toggle navigation','hotel-galaxy'); ?></span>
							...
							<div class="site-logo">		
								<a href="<?php echo esc_url( home_url( '/' ) ); ?>">
									...
									if(has_custom_logo()){ 
										...
										<?php
									}else{	?> <h4 class="htlg-site-title" style ="color:#4f2759"><?php echo esc_attr(get_bloginfo('name')); ?></h4>
