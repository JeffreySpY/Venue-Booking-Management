<center>
<form method="get"  class="form-inline" action="<?php echo get_site_url(null,"/venue/","https");?>">
 	...
 	<div class="sb-widget-inner" >
 		<div class="form-group input-group"   >
            <div >
                ...
                <input   class="custom-btn book-sm" id="basic-addon2" value="Search" type="submit" style="background-color:#e7ad44"  ></input>
            </div >
            <hr>
            <p>
