<?php 
function hotel_galaxy_nav_walker( $args ) {
...
add_filter( 'wp_page_menu_args', 'hotel_galaxy_nav_walker' );


function hotel_galaxy_fallback_page_menu( $args = array() ) {
...
class hotel_galaxy_walker_page_menu extends Walker_Page{
