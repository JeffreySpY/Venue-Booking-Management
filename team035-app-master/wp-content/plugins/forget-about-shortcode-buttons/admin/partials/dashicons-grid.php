			...
			<!-- media -->
			<!-- This section will be launched on release of WordPress 3.9. Please don't used these icons until then.-->
			...
			<div data-code="f211" class="dashicons dashicons-editor-distractionfree"></div>
			...
			<!-- This section will be launched on release of WordPress 3.9. Please don't used these icons until then.-->
			<div data-code="f464" class="dashicons dashicons-editor-break"></div>
			...
			<!-- widgets -->
			<!-- This section will be launched on release of WordPress 3.9. Please don't used these icons until then. -->
			<div data-code="f478" class="dashicons dashicons-archive"></div>
			<div data-code="f479" class="dashicons dashicons-tagcloud"></div>
			<div data-code="f480" class="dashicons dashicons-text"></div>
