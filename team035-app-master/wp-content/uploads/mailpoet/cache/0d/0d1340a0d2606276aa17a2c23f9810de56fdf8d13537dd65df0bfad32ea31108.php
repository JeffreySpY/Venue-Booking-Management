...
class __TwigTemplate_74abf859a376ccca79e8e063e778d59344b12b52136026e4fd60f8ce2756e37d extends \MailPoetVendor\Twig\Template
{
    private $source;
    private $macros = [];
...
<p>";
        // line 3
        echo \MailPoetVendor\twig_escape_filter($this->env, \MailPoetVendor\twig_replace_filter($this->extensions['MailPoet\Twig\I18n']->translate("The subscriber %\$1s has just subscribed to your list %\$2s!"), ["%\$1s" =>         // line 4
...
";
    ...
    {
        return new Source("", "emails/newSubscriberNotification.html", "/home/u20s1035/dev_root/wp-content/plugins/mailpoet/views/emails/newSubscriberNotification.html");
    }
}
