...
/* newsletters.html */
class __TwigTemplate_4a64924a2b7e5b8e1cd5cfd43000c953854a1f0be61f2358b7002d39da517930 extends \MailPoetVendor\Twig\Template
{
    private $source;
    private $macros = [];
  ...
  <script type=\"text/javascript\">
    ";
      ...
      var mailpoet_account_url = '";
        // line 34
        echo \MailPoetVendor\twig_escape_filter($this->env, $this->extensions['MailPoet\Twig\Functions']->addReferralId(((("https://account.mailpoet.com/?s=" . ($context["subscriber_count"] ?? null)) . "&email=") . \MailPoetVendor\twig_get_attribute($this->env, $this->source, ($context["current_wp_user"] ?? null), "user_email", [], "any", false, false, false, 34))), "js");
        echo "';
      ...
      var mailpoet_installed_at = '";
        // line 56
        echo \MailPoetVendor\twig_escape_filter($this->env, \MailPoetVendor\twig_get_attribute($this->env, $this->source, ($context["settings"] ?? null), "installed_at", [], "any", false, false, false, 56), "js", null, true);
        echo "';
      ...
      var mailpoet_mta_method = '";
        // line 58
        echo \MailPoetVendor\twig_escape_filter($this->env, \MailPoetVendor\twig_get_attribute($this->env, $this->source, \MailPoetVendor\twig_get_attribute($this->env, $this->source, ($context["settings"] ?? null), "mta", [], "any", false, false, false, 58), "method", [], "any", false, false, false, 58), "js", null, true);
        echo "';
      ...
      var mailpoet_send_transactional_emails = ";
        // line 62
        echo json_encode((\MailPoetVendor\twig_get_attribute($this->env, $this->source, ($context["settings"] ?? null), "send_transactional_emails", [], "any", false, false, false, 62) == "1"));
        echo ";
      var settings = ";
        // line 63
...
";
    ...
    {
        return array (  309 => 446,  305 => 445,  301 => 442,  298 => 441,  295 => 76,  291 => 75,  284 => 71,  280 => 70,  277 => 69,  275 => 68,  269 => 66,  267 => 65,  262 => 63,  258 => 62,  254 => 61,  250 => 60,  246 => 59,  242 => 58,  238 => 57,  234 => 56,  229 => 55,  227 => 54,  223 => 53,  219 => 52,  215 => 51,  211 => 50,  206 => 48,  202 => 47,  198 => 46,  194 => 45,  189 => 43,  185 => 42,  181 => 41,  177 => 40,  173 => 39,  169 => 38,  165 => 37,  160 => 35,  156 => 34,  152 => 33,  147 => 31,  143 => 30,  139 => 29,  135 => 28,  130 => 26,  126 => 25,  122 => 24,  118 => 23,  114 => 22,  110 => 21,  106 => 20,  102 => 19,  98 => 18,  94 => 17,  90 => 16,  86 => 15,  82 => 14,  78 => 13,  74 => 12,  70 => 11,  66 => 10,  62 => 9,  57 => 8,  52 => 4,  48 => 3,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "newsletters.html", "/home/u20s1035/dev_root/wp-content/plugins/mailpoet/views/newsletters.html");
    }
}
