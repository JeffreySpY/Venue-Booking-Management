...
/* welcome_wizard.html */
class __TwigTemplate_ca4203135fd73da4c88f698f79f5d64ca66bd53d55c6db647de07f9876dd22c5 extends \MailPoetVendor\Twig\Template
{
    private $source;
    private $macros = [];
  ...
  var mailpoet_account_url = '";
        // line 18
        echo \MailPoetVendor\twig_escape_filter($this->env, \MailPoetVendor\twig_escape_filter($this->env, $this->extensions['MailPoet\Twig\Functions']->addReferralId(((("https://account.mailpoet.com/?s=" . ($context["subscriber_count"] ?? null)) . "&email=") . \MailPoetVendor\twig_get_attribute($this->env, $this->source, ($context["current_wp_user"] ?? null), "user_email", [], "any", false, false, false, 18))), "js"), "html", null, true);
        echo "';
...
";
    ...
    public function block_translations($context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 32
        echo $this->extensions['MailPoet\Twig\I18n']->localize(["welcomeWizardLetsStartTitle" => $this->extensions['MailPoet\Twig\I18n']->translate("Welcome! Let’s get you started on the right foot."), "welcomeWizardSenderText" => $this->extensions['MailPoet\Twig\I18n']->translate("Who is the sender of the emails you’ll be creating with MailPoet?"), "welcomeWizardSenderMigratedUserText" => $this->extensions['MailPoet\Twig\I18n']->translate("We have a few things to tell you before you begin to ensure you have a good experience."), "welcomeWizardUsageTrackingStepTitle" => $this->extensions['MailPoet\Twig\I18n']->translate("Help MailPoet improve with anonymous usage tracking."), "welcomeWizardUsageTrackingStepSubTitle" => $this->extensions['MailPoet\Twig\I18n']->translate("Data we don’t gather:"), "welcomeWizardTrackingText" => $this->extensions['MailPoet\Twig\I18n']->translate("Gathering usage data allows us to make MailPoet better — the way you use MailPoet will be considered as we evaluate new features, judge the quality of an update, or determine if an improvement makes sense."), "welcomeWizardTrackingList1" => $this->extensions['MailPoet\Twig\I18n']->translate("Any personal data"), "welcomeWizardTrackingList2" => $this->extensions['MailPoet\Twig\I18n']->translate("Email addresses"), "welcomeWizardTrackingList3" => $this->extensions['MailPoet\Twig\I18n']->translate("Login and passwords"), "welcomeWizardTrackingList4" => $this->extensions['MailPoet\Twig\I18n']->translate("Content of your emails"), "welcomeWizardTrackingList5" => $this->extensions['MailPoet\Twig\I18n']->translate("Open and click rates"), "welcomeWizardTrackingLink" => $this->extensions['MailPoet\Twig\I18n']->translate("Read more about what we collect."), "welcomeWizardEmailCourseTitle" => $this->extensions['MailPoet\Twig\I18n']->translate("Sign up to our 4-part email course"), "welcomeWizardEmailCourseText" => $this->extensions['MailPoet\Twig\I18n']->translate("A must for every beginner (in English only)"), "seeVideoGuide" => $this->extensions['MailPoet\Twig\I18n']->translateWithContext("See video guide", "A label on a button"), "skip" => $this->extensions['MailPoet\Twig\I18n']->translateWithContext("Skip", "A label on a skip button"), "finishLater" => $this->extensions['MailPoet\Twig\I18n']->translateWithContext("Finish later", "A label on a skip button"), "allowAndFinish" => $this->extensions['MailPoet\Twig\I18n']->translateWithContext("Allow & Finish", "A label on a button"), "allowAndContinue" => $this->extensions['MailPoet\Twig\I18n']->translateWithContext("Allow & Continue", "A label on a button"), "senderAddress" => $this->extensions['MailPoet\Twig\I18n']->translateWithContext("From Address", "A form field label"), "replyToAddress" => $this->extensions['MailPoet\Twig\I18n']->translateWithContext("Reply-to Address", "A form field label"), "senderName" => $this->extensions['MailPoet\Twig\I18n']->translateWithContext("From Name", "A form field label"), "next" => $this->extensions['MailPoet\Twig\I18n']->translateWithContext("Next", "A label on a button"), "continue" => $this->extensions['MailPoet\Twig\I18n']->translateWithContext("Continue", "A label on a button")]);
        // line 57
        echo "
";
        // line 58
        $this->loadTemplate("mss_pitch_translations.html", "welcome_wizard.html", 58)->display($context);
        // line 59
        $this->loadTemplate("woocommerce_setup_translations.html", "welcome_wizard.html", 59)->display($context);
    }
    ...
    {
        return array (  136 => 59,  134 => 58,  131 => 57,  129 => 32,  125 => 31,  111 => 20,  107 => 19,  103 => 18,  99 => 17,  94 => 15,  90 => 14,  86 => 13,  82 => 12,  78 => 11,  74 => 10,  70 => 9,  66 => 8,  62 => 7,  58 => 6,  54 => 5,  51 => 4,  47 => 3,  36 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "welcome_wizard.html", "/home/u20s1035/dev_root/wp-content/plugins/mailpoet/views/welcome_wizard.html");
    }
}
